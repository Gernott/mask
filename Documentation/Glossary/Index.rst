...
good practice to include it nervertheless. Most of the time you will want some generic content elements for your site.
Also you can use the standard layout of Fluid Styled Content by :ref:`specifying the paths in TypoScript <fsc-guide>`.
