...
+ **Title**: enter the title for this contentelement. It is seen by the editor on creating a new content.

+ **Element-key (unique, lowercase)**: your element needs an elementkey. This key is used internally and is not seen by the editor. It must be uniqe in the whole installation and in lowercase letters. The key is used in the databaes and as filename for the HTML-template and the preview-image.
...
A preview-image is saved in your defined preview-folder. Usually it is in: fileadmin/templates/preview. You can (you should :-) overwrite this image with your prefered preview-image. Ideally this should be a screenshot of your element or a nice icon. The image will be shown in 1:1 size. So you should save the image with a maximum width of 150 pixel. Height doesn't matter.
