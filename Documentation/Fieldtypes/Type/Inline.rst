...
*  `config.appearance.showNewRecordLink <https://docs.typo3.org/m/typo3/reference-tca/main/en-us/ColumnsConfig/Type/Inline/Properties/ShowNewRecordLink.html>`__ (only v11 or higher)
