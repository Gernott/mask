...
### Security
- Path traversal like creation of HTML files

## [9.0.10] - 2026-01-28

### Added
- Support for Record API _computed property [#681](https://github.com/Gernott/mask/issues/681)

## [9.0.9] - 2025-09-12

### Added
- Default field for type Link [#683](https://github.com/Gernott/mask/issues/683)

### Fixed
- Error in MoveRteOptions Update Wizard

## [9.0.8] - 2025-05-16

### Fixed
- Migrate legacy link renderType inputLink [#674](https://github.com/Gernott/mask/issues/674)
- Add compatibility for "allowed" as array notation [#679](https://github.com/Gernott/mask/pull/679) (thanks to @aseemann)
