...
### Fixed
- Allowed file extensions for links working [#432](https://github.com/Gernott/mask/issues/432)
...
### Fixed
- Allowed content (CType) restriction works again [#396](https://github.com/Gernott/mask/issues/396)

## [4.2.0] - 2021-02-08

### Changed
- Followup release with typo3 tailor

## [4.1.5] - 2021-02-08

### Fixed
- Add missing softref for rte fields [#383](https://github.com/Gernott/mask/issues/383)

## [4.1.4] - 2020-12-14

### Fixed
- Backend preview now shows changes from workspace [#377](https://github.com/Gernott/mask/issues/377)
- Removed duplicate inline elements in workspace preview [#244](https://github.com/Gernott/mask/issues/244)

## [4.1.3] - 2020-11-02

### Fixed
- Translation of repeater in page records [#258](https://github.com/Gernott/mask/issues/258)
